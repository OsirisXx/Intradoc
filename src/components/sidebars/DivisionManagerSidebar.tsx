  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="nav">
        ...
        <NavLink to="/division-manager/review" className="nav-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <NavLink to="/division-manager/upload" className="nav-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <NavLink to="/division-manager/tasks" className="nav-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
